      ...
      <section className="relative z-10 w-full max-w-lg rounded-3xl border border-border/70 bg-surface/80 px-8 py-10 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="relative">
            ...
            <h1 className="relative text-6xl font-semibold tracking-tight bg-linear-to-br from-primary via-primary-light to-accent bg-clip-text text-transparent animate-pulse">
              404
            </h1>
          </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-3 w-full">
            <Link
              to={TOP_PATH}
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full bg-primary px-6 py-2.5 text-sm font-semibold text-secondary shadow-lg shadow-primary/40 hover:bg-primary-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-light transition"
            >
              <span>Go Home</span>
            ...
            <button
              type="button"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-border px-6 py-2.5 text-sm font-medium text-secondary-foreground hover:bg-secondary/80 hover:border-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-light transition"
            >
              Contact support
            </button>
          </div>
